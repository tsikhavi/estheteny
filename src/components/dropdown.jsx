...
export default function DropDown() {
  return (
    <div className="fixed mt-5 z-100 w-56 text-right">
      <Menu as="div" className="relative inline-block text-left text-black bg-fuchsia-500 mt-0">
        <div>
            ...
            <div className="px-1 py-1 ">
              <Menu.Item>
                {({ active }) => (
                  <button
                    className={`${
                      active ? 'bg-fuchsia text-white' : 'text-gray-900'
