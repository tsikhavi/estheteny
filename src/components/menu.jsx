  ...
  return (
    <div class="grid grid-cols-2 gap-8">
      <div className="w-full max-w-md px-2 py-16 sm:px-0 ">
        <Tab.Group>
          <Tab.List className="flex space-x-1 rounded-xl bg-fuchsia-700/20 p-1">
              ...
              <Tab
                ...
                className={({ selected }) =>
                  classNames(
                    ...
                    selected ? 'bg-white text-gray-700 shadow' : 'text-gray-500 hover:bg-white/[0.12] hover:text-white'
                  )
                }
              >
                {category}
