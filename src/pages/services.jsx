        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="lg:py-24">
              ...
              <Link
                href="#"
                className="mt-8 inline-block rounded bg-allports-600 px-12 py-3 text-sm font-medium text-black transition hover:bg-allports-700 focus:outline-none focus:ring focus:ring-yellow-400"
              >
                Get Started Today
              </Link>
