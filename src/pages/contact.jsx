...
const siteTitle = 'contactesthete';
const ContactForm = () => {
    ...
    <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        {['Regular', 'Deep', 'Post Renovation', 'After Party'].map((option, index) => (
          <div key={index}>
            ...
            <label
              ...
              } p-3 text-gray-600 hover:bg-allports-100 hover:border-allports-100 peer-checked:border-allports-100 peer-checked:bg-allports-800 peer-checked:text-white`}
              tabIndex="0"
            >
      ...
      <div className="flex">
        <div className="mt-4 mr-4">
          <button
            type="submit"
            className="inline-block w-full rounded-lg bg-allports-800 hover:bg-allports-700 py-3 px-10 font-medium text-white sm:w-auto"
          >
            Send Enquiry
  ...
  return (
    <>
      ...
      <section className="bg-inherit mt-20 mb-0">
        <h1 className="text-3xl font-bold text-allports-700 text-center mt-8 px-20">
          Quick Contact
          <span className="inline-flex px-2">
          ...
          <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
            <div className="lg:col-span-2 lg:py-12">
              <p className="max-w-xl text-lg">
                ...
                here to assist you. Get in touch with us today to schedule an appointment or request a quote. Our
                customer support representatives are available to address your inquiries and discuss how we can
                customize our services to accommodate your preferences.
                <br /> You can reach us via phone at{' '}
                <Link href="" className="text-base font-bold text-allports-600">
                  {' '}
                  +1 (646)578-0645{' '}
                </Link>{' '}
                ...
                <Link
                  ...
                  className="bg-allports-300 hover:underline hover:text-allports-900"
                >
                  esthete.cleaning@gmail.com
                  <span className="w-4 h-4 inline-flex hover:text-allports-800 ">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 " viewBox="0 0 512 512">
                      <path
                        fill="currentColor"
            ...
            <div className="rounded-lg bg-allports-50 p-8 shadow-lg lg:col-span-3 lg:p-12">
              <ContactForm />
            </div>
          </div>
        </div>
